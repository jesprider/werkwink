...
**Current codebase snapshot (after iteration 20):**
...
- Landing: full static page at `/` with hill illustration, forces/ritual explainers, privacy note, Try it live CTA.
...
| 20 | `docs/superpowers/specs/2026-06-10-werkwink-iteration-20-landing-page-design.md` |
